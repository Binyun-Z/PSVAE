...
EMB_LAYER = 33
CHECKPOINT_PATH = './ESM_finetuning/checkpoint_cnn1d2'
import os
import pandas as pd
import pathlib
import pandas as pd
...
def main(net, train_dataloader, val_dataloader, loss, trainer, num_epochs, start_epoch, devices = utils.try_all_gpus()):
    ...
    #默认使用logger的级别
    fileHandler = logging.FileHandler(filename = "./ESM_finetuning/Finetuning_ESM_log/esm_cnn_acc2.log")
    #格式
